...
function badLetDeclaration() {
	...
	function doDeclaration(x) {
		...
		let johnCena2 = "1";
		let johnCena3 = 1.0;
		let johnCena4 = new Date();
		let johnCena5 = 1 + i;
		let realJohnCena = new Person("John Cena", 22);
		let realJohnCena2 = new Person("John Cena", 22);
		let realJohnCena3 = new Person("John Cena", 22);
...
function goodArrayDeclaration() {
	...
	function doDeclaration() {
		let johnCenas = ["And his name is John Cena!", "And his name is John Cena 2!"];
	}
